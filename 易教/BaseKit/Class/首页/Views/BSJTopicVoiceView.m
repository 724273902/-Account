...
- (void)setTopicViewModel:(ZXViewModel *)topicViewModel
{
    ...
    [self.pictureImageView lmj_setImageWithURL:topicViewModel.topicItem.largePicture thumbnailImageURL:topicViewModel.topicItem.smallPicture placeholderImage:nil options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL *targetUrl) {
